...
public class Reestrasia extends JFrame {
	...
	public Reestrasia(String s) {
		...
		label_NazvaVikna.setForeground(Color.ORANGE);
		...
		label_Login.setForeground(Color.ORANGE);
		...
		label_Password.setForeground(Color.ORANGE);
		...
		button_Nazad.setForeground(Color.MAGENTA);
		button_Nazad.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new Avtor("Посадовий профіль");
				setVisible(false);
			}
		});
		...
		label_PIP.setForeground(Color.ORANGE);
		...
		label_email.setForeground(Color.ORANGE);
		...
		button_Gotovo.setForeground(Color.MAGENTA);
		...
		label.setIcon(new ImageIcon("res/fon/Reestracia1.png"));
